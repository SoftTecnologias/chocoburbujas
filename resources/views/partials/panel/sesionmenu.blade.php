...
<header class="main-header">
    <!-- Header Navbar -->
    <a href="{{route('panel.area')}}" class="logo">
        <div class="pull-left image logo-lg">
            {{Html::image('images/logo150.png','Chocourbujas',['class'=>'img-responsive'])}}
        </div>
        <div class="pull-left image logo-mini">
            {{Html::image('images/logo50.png','Chocourbujas',['class'=>'img-responsive'])}}
        </div>
    </a>
